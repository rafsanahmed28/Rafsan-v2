...
const blogArticles = [
  {
    id: 1,
    title:
      "How I Built My Portfolio Website with Popular Coding Tools — Without a Coding Background",
    description:
      "A journey of vision, curiosity, and how AI empowered me to build my data analyst portfolio that once felt impossible.",
    image: "https://cdn-images-1.medium.com/v2/resize:fit:800/1*tMEUkqqBtQ4v-LBbCzLqZA.jpeg",
    mediumUrl:
      "https://medium.com/@rafsanahmed2828/how-i-built-my-portfolio-website-with-popular-coding-tools-without-a-coding-background-e874e863da4d",
    date: "June 2025",
  },
  {
    id: 2,
    ...
    description:
      "A conclusive study of Cyclistic’s bike users and user patterns & behaviors using SQL and Tableau.",
...
const ProjectBlogs = () => {
  ...
  return (
    <section ref={sectionRef} className="blog-slideshow-section">
      <h2 ref={titleRef} className="blog-section-title">
        Project <span className="gradient-text">Blogs</span>
      </h2>
      ...
      <div ref={slideshowRef} className="blog-slideshow-container">
        ...
        {blogArticles.map((article, index) => (
          ...
          >
            ...
            <div ref={(el) => (slideTextRefs.current[index] = el)} className="slide-content">
            ...
            <div className="article-links">
              <a
                ...
                className="medium-link btn-effect"
              >
